...
class Part(Datastructure):
    ...
    @classmethod
    def from_line(cls, line, name=None, frame=None):
        """Construct an element from a line.

        Parameters
        ----------
        line::class:`compas.geometry.Line`
            Line describing the part.
        frame::class:`Frame`
            Origin frame of the part.
        name: str
            Name of the part.
    ...
    @classmethod
    def from_point(cls, point, name=None, frame=None):
        """Construct an element from a point.

        Parameters
        ----------
        point::class:`compas.geometry.Point`
            Point describing the part.
    ...
    :class:`Part`
        ...
        """
        part = cls(name, frame)
        part.shape = point  # Assign the point as the shape
        return part
